...
output:
    html_document:
        ...
        toc_depth: 2  
params:
  data: "survival_data.tsv"
  resdir: "results"
  accession2species: "../genotype2species.txt"
---
...
print(getwd())
survData = read.delim("survival_data.tsv",header = T,stringsAsFactors = F)

# change column names
colnames(survData) = c("accession","time","status")

# import accessions to species correspondence
accession2species = read.delim("../genotype2species.txt",header = T,sep = "\t",stringsAsFactors = F)
```
...
# add species
df = read.delim("medians.tsv",header=T,stringsAsFactors = F)
