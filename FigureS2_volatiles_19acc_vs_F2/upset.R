...
# pie chart (% of compounds and their occurence): 20% of the volatiles occur only one time
# ggplot(classes.occurences,aes(x = "",y=percentage,fill=class.occurence)) +
#   geom_bar(stat="identity") +
#   coord_polar(theta = "y",start = 0) +
#   scale_fill_manual(values=get_palette(palette = "Set1",k = 18)) 
