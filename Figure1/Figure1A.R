...
ggsave(filename = file.path("Figure1/","wf_survival_19_accessions.png"),plot = survival,width=7,height=3,dpi = 300)
ggsave(filename = file.path("Figure1/","wf_survival_19_accessions.svg"),plot = survival,width=7,height=3)
